...
public class My01Controller {
    ...
    public String mainPage(Model model) {
        List<String> pageNames = List.of("model", "increase", "fragments", "if-unless", "DTO1", "DTO2", "GET_querystring", "GET_pathvariable", "POST_formdata", "final_chatbot");
    ...
    public String ex05(Model model) {
        ...
        MemberData smember = new MemberData("슈퍼맨", LocalDate.of(1991, 5, 15));
    ...
    public String ex06(Model model) {
        // BungBbang(java 파일명/dto 파일명?) pbbang(변수?명) = new BungBbang(String "팥빵", int 1000, LocalDate.of(2025, 6, 4));
        List<BungBbang> bungs = List.of(
            new BungBbang("팥붕어빵", 1000, LocalDate.of(2025, 6, 4)),
            new BungBbang("슈크림붕어빵", 1500, LocalDate.of(2025, 6, 4)),
            new BungBbang("피자붕어빵", 1500, LocalDate.of(2025, 6, 4))
        );
        model.addAttribute("bungs", bungs);
        return "ex06"; // templates/ex05.html
    }

    @GetMapping("/GET_querystring")
    public String ex07(@RequestParam(required = false) String inName, String inAge, String inGen, String want, String allow, Model model) {
    ...
    public String ex09Post(@RequestParam String name, @RequestParam String age, Model model) {
        ...
        try {
            ...
            model.addAttribute("error", "나이는 숫자로 입력해야합니다.");
        }
        return "ex09";
    }
