...
const Inp3 = () => {
    ...
    const handleIn2 = e => setIn1(e.target.value)
    ...
    return (
        <>
            ...
            <div>
                ...
                <input type="text" value={in1} onChange={handleIn2}/> = {in1 * 1 + in2 * 1}
            </div>
            <div>
                <input type="text" value={in1} onChange={handleIn1}/> - {" "}
                <input type="text" value={in1} onChange={handleIn2}/> = {in1 * 1 - in2 * 1}
            ...
            <div>
                ...
                <input type="text" value={in1} onChange={handleIn2}/> = {in1 * in2 * 1}
            </div>
            <div>
                <input type="text" value={in1} onChange={handleIn1}/> / {" "}
                <input type="text" value={in1} onChange={handleIn2}/> = {in1 / in2}
            </div>
            <hr />
